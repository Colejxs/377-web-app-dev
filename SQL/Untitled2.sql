...
INSERT INTO teams (tms_id, tms_city, tms_name) VALUE (11, 'Weymouth', 'Wild Cats');
...
INSERT INTO players (pla_tms_id, pla_first_name, pla_last_name, pla_number, pla_position, pla_dob)
	VALUES(1, 'Jacob', 'Demong', 9, 'Quarterback', '2005-08-08');
INSERT INTO players (pla_tms_id, pla_first_name, pla_last_name, pla_number, pla_position, pla_dob)
	VALUES(1, 'Hayden', 'Daley', 24, 'Point Guard', '2004-12-16');
INSERT INTO players (pla_tms_id, pla_first_name, pla_last_name, pla_number, pla_position, pla_dob)
	VALUES(2, 'Eric', 'Cartman', 3, 'Nose Tackle', '2014-03-14');
INSERT INTO players (pla_tms_id, pla_first_name, pla_last_name, pla_number, pla_position, pla_dob)
	VALUES(2, 'Stan', 'Marsh', 4, 'Running Back', '2014-06-28');

SELECT * FROM players;

-- Find Teams Without any players
SELECT *
	FROM teams
    LEFT OUTER JOIN players ON pla
